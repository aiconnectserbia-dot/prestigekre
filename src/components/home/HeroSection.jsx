...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-[#F5F1E8] via-[#F0EBE3] to-[#F5F1E8] overflow-hidden w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[85vh]">
          ...
          >
            ...
            >
              ...
              />
              <div className="flex items-center gap-2 px-4 py-2 bg-amber-500/20 lg:bg-white/20 rounded-full border border-amber-500/30 lg:border-white/30">
                <div className="w-2 h-2 bg-amber-500 lg:bg-white rounded-full animate-pulse"></div>
                <span className="text-amber-800 lg:text-white font-semibold text-sm">Profesionalne usluge</span>
              </div>
            </motion.div>
            ...
            <div className="space-y-4">
              ...
              >
                <span className="text-stone-900 lg:text-stone-100">Radimo </span>
                <span className="text-stone-800 lg:text-stone-300">čisto</span>
                <span className="text-stone-900 lg:text-stone-100">, </span>
                <br />
                <span className="text-stone-800 lg:text-stone-300">kvalitetno</span>
                <span className="text-stone-900 lg:text-stone-100">, </span>
                <br />
                <span className="text-stone-800 lg:text-stone-300">profesionalno</span>
                <br />
                <span className="text-stone-900 lg:text-stone-100">i na </span>
                <span className="text-stone-800 lg:text-stone-300">nivou.</span>
              </motion.h1>
            </div>
            ...
            <motion.p 
              ...
              className="text-stone-600 lg:text-stone-200 text-lg lg:text-xl leading-relaxed max-w-xl"
            >
            ...
            >
              <div className="text-center p-4 bg-white/60 lg:bg-white/90 rounded-xl border border-amber-200/50 lg:border-white/50">
                <Award className="w-8 h-8 text-amber-600 lg:text-stone-700 mx-auto mb-2" />
                <p className="text-2xl font-bold text-stone-900">10+</p>
                <p className="text-stone-600 text-sm">Godina</p>
              </div>
              <div className="text-center p-4 bg-white/60 lg:bg-white/90 rounded-xl border border-amber-200/50 lg:border-white/50">
                <Users className="w-8 h-8 text-amber-600 lg:text-stone-700 mx-auto mb-2" />
                <p className="text-2xl font-bold text-stone-900">200+</p>
                <p className="text-stone-600 text-sm">Projekata</p>
              </div>
              <div className="text-center p-4 bg-white/60 lg:bg-white/90 rounded-xl border border-amber-200/50 lg:border-white/50">
                <CheckCircle className="w-8 h-8 text-amber-600 lg:text-stone-700 mx-auto mb-2" />
